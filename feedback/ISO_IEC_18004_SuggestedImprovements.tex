...
that some of the concrete  QR codes shown in the standard itself deviate from the Data Masking Pattern choice prescribed
by the standard, is currently a source of confusion. This is discussed in Section~\ref{sec:dmp-scoring}, below.
...
in Annex~I, this table lists the four score terms and the total score for each data masking pattern choice:
